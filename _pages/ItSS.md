...
feature_row:
  - image_path: /images/theAnthroposcene.jpeg
    ...
    title: "Anthropocene"
    excerpt: "The anthropocene can be summarized with two insights: first, for the first time in human history we know that we are overusing this planets capacity to sustain society as we know it and secondly, we are the last generation to do something about it. Shall we get started?"
